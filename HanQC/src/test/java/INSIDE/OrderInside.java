...
//        driver.findElement(By.xpath("//*[@id='frmOrderInfo']/div[4]/div[1]/div/select/option[11]")).click(); // EMS
//        driver.findElement(By.xpath("//*[@id='frmOrderInfo']/div[4]/div[1]/div/select/option[5]")).click(); // Tiktok
//        driver.findElement(By.xpath("//*[@id='frmOrderInfo']/div[4]/div[1]/div/select/option[]")).click();//Nhat tin
...
//        driver.findElement(By.xpath("//*[@id='frmOrderInfo']/div[4]/div[1]/div/select/option[6]")).click(); // vettel
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@class='select2-search__field']")).sendKeys("100240041");
        Thread.sleep(1000);
        ...
        driver.findElement(By.id("add_item_qty")).sendKeys("1"); // SL SKU
...
//        Thread.sleep(1000);
//        driver.findElement(By.xpath("//*[@class='select2-search__field']")).sendKeys("100070048");
//        Thread.sleep(2000);
//        driver.findElement(By.xpath("//*[@class='select2-search__field']")).click();
//        driver.findElement(By.xpath("//*[@role='treeitem']")).click();
//        driver.findElement(By.id("add_item_qty")).clear();
//        driver.findElement(By.id("add_item_qty")).sendKeys("1"); // SL SKU
//        Thread.sleep(2000);
//        driver.findElement(By.xpath("//*[@id='btn_add_item']")).click(); // them sku
//        Thread.sleep(1000);
